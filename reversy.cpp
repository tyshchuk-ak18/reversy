...
int main() {
	...
	while(1) {
		...
		StringCchPrintf(title, MAX_PATH, TEXT("FPS=%3.2f FPS_Max=%3.2f FPS_Min=%3.2f Hesh=%1.0f"), 1.0f / fElapsedTime, 1.0f / fMinElapsedTime, 1.0f / fMaxElapsedTime, (float)nShade);
